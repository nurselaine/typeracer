...
/*
*             *
 * During the next milestone, we will create a threaded server,
 * and implement the three RPC's students have designed.
 *
 * The data that is transferred between the Client and Server
 * should be string. It is beyond the scope of this class to
 * pass integers in their raw form.
 *
 * */